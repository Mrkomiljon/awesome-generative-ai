...
|:---|:---|:---|:---|:---|:---|
| 27,273 | **AutoGPT** | 178,639 | Significant-Gravitas | Accessible AI tools for building and using AI agents | [Repo](https://github.com/Significant-Gravitas/AutoGPT) |
| 161,074 | **Ollama** | 152,864 | Ollama | Tool for running large language models locally | [Repo](https://github.com/ollama/ollama) |
| 125,436 | **LangChain** | 116,010 | LangChain AI | Framework enabling context-aware reasoning applications | [Repo](https://github.com/langchain-ai/langchain) |
| 71,260 | **Lobe Chat** | 65,772 | LobeHub | Open-source UI framework for ChatGPT/LLM-based chat apps | [Repo](https://github.com/lobehub/lobe-chat) |
| 67,287 | **OpenDevin** | 63,694 | OpenDevin | Open-source autonomous AI software engineer | [Repo](https://github.com/OpenDevin/OpenDevin) |
| 61,916 | **Open Interpreter** | 60,543 | OpenInterpreter | Coding agent enabling language models to execute code locally | [Repo](https://github.com/OpenInterpreter/open-interpreter) |
| 63,631 | **MetaGPT** | 58,552 | Geekan | Multi-agent framework enabling GPT collaboration | [Repo](https://github.com/geekan/MetaGPT) |
| 57,096 | **PrivateGPT** | 56,605 | Zylon AI | Secure, offline-capable AI tool for querying documents | [Repo](https://github.com/zylon-ai/private-gpt) |
...
| 54,044 | **AutoGen** | 50,058 | Microsoft | Multi-agent conversation framework for LLM applications | [Repo](https://github.com/microsoft/autogen) |
...
|:---|:---|:---|:---|:---|
| **Flowise** | 48,681 | FlowiseAI | Drag-and-drop interface for AI workflows | [Repo](https://github.com/FlowiseAI/Flowise) |
| **FastChat** | 39,390 | LM-SYS | Platform for training, serving, and evaluating LLM chatbots | [Repo](https://github.com/lm-sys/FastChat) |
| **Cal.ai** | 39,928 | Cal.com | Open-source AI scheduling assistant | [Repo](https://github.com/calcom/cal.com/tree/main/apps/ai) |
| **Aider** | 40,181 | Paul Gauthier | Command-line tool for AI-assisted pair programming | [Repo](https://github.com/paul-gauthier/aider) |
| **Jan** | 40,247 | JanHQ | Open-source ChatGPT alternative that operates offline | [Repo](https://github.com/janhq/jan) |
| **CrewAI** | 43,349 | João Moura | Framework for orchestrating role-playing AI agents | [Repo](https://github.com/joaomdmoura/crewai) |
| **AgentGPT** | 35,635 | Reworkd | Configure and deploy autonomous AI agents | [Repo](https://github.com/reworkd/AgentGPT) |
| **GPT Pilot** | 33,759 | Pythagora | Open-source AI developer tool | [Repo](https://github.com/Pythagora-io/gpt-pilot) |
| **Tabby** | 32,810 | TabbyML | Self-hosted, open-source AI coding assistant | [Repo](https://github.com/TabbyML/tabby) |
...
|:---|:---|:---|:---|
| **SWE-agent** | 18,355 | Software engineering agent for GitHub repositories | [Repo](https://github.com/princeton-nlp/SWE-agent) |
| **Sweep** | 7,630 | AI tool that transforms GitHub issues into pull requests | [Repo](https://github.com/sweepai/sweep) |
| **Continue** | 31,155 | Open-source autopilot plugin for VS Code and JetBrains | [Repo](https://github.com/continuedev/continue) |
...
| Agent | Stars | Description | Links |
|:---|:---|:---|:---|
| **GPT Researcher** | 25,123 | AI-powered autonomous agent for online research | [Repo](https://github.com/assafelovic/gpt-researcher) |
...
| Agent | Stars | Description | Links |
|:---|:---|:---|:---|
| **ShortGPT** | 7,054 | AI-powered framework for automating content creation | [Repo](https://github.com/RayVentura/ShortGPT) |
...
|:---|:---|:---|:---|
| **LangGraph** | 23,983 | Python library for stateful, multi-actor applications with LLMs | [Repo](https://github.com/langchain-ai/langgraph) |
| **SuperAGI** | 17,134 | Open-source framework for autonomous AI agents | [Repo](https://github.com/TransformerOptimus/SuperAGI) |
| **XAgent** | 8,490 | Open-source autonomous agent for complex task solving | [Repo](https://github.com/OpenBMB/XAgent) |
| **BabyAGI** | 22,099 | AI-powered task management system with OpenAI | [Repo](https://github.com/yoheinakajima/babyagi) |
| **ChatDev** | 29,045 | Virtual software company with intelligent agents | [Repo](https://github.com/OpenBMB/ChatDev) |
| **CAMEL** | 15,867 | Communicative agents for mind exploration | [Repo](https://github.com/camel-ai/camel) |
| **AgentVerse** | 4,927 | Multi-LLM agent framework for various applications | [Repo](https://github.com/OpenBMB/AgentVerse) |
| **AgentCPM** | - | OpenBMB multi-agent framework built around CPM models and tooling | [Repo](https://github.com/OpenBMB/AgentCPM) |
| **Swarms** | 5,662 | Multi-agent collaboration for production applications | [Repo](https://github.com/kyegomez/swarms) |
| **Agno** | - | Agent framework for building multi-agent systems and tools | [Repo](https://github.com/agno-agi/agno) |
| **PraisonAI** | 5,573 | Low-code framework leveraging AutoGen and CrewAI | [Repo](https://github.com/MervinPraison/PraisonAI) |
| **TaskingAI** | 5,364 | Platform for AI-native app development | [Repo](https://github.com/TaskingAI/TaskingAI) |
...
|:---|:---|:---|:---|
| **MemGPT** | 20,894 | Customizable AI chatbot with self-editing memory | [Repo](https://github.com/cpacker/MemGPT) |
| **Letta** | - | Agent framework with long-term memory (MemGPT successor) | [Repo](https://github.com/letta-ai/letta) |
| **Zep** | 4,019 | Long-term memory service for AI assistants | [Repo](https://github.com/getzep/zep) |
| **LocalGPT** | 22,147 | Private document interactions with local LLMs | [Repo](https://github.com/PromtEngineer/localGPT) |
...
| **mem46,251** | - | Open-source memory layer for LLM apps | [Repo](https://github.com/mem0ai/mem0) |
...
| **ScrapeGraphAI** | 22,432 | AI agents for automated web scraping | [Repo](https://github.com/VinciGit00/Scrapegraph-ai) |
| **Self Operating Computer** | 10,122 | Multimodal models for computer interaction | [Repo](https://github.com/OthersideAI/self-operating-computer) |
| **AppAgent** | 6,490 | Mobile-friendly LLM-based multimodal agent | [Repo](https://github.com/mnotgod96/AppAgent) |
...
| **crawl59,194ai** | - | AI-first web crawler and scraper | [Repo](https://github.com/unclecode/crawl4ai) |
...
|:---|:---|:---|:---|
| **AgentBench** | 3,131 | Benchmark for evaluating LLM agents | [Repo](https://github.com/THUDM/AgentBench) |
| **AgentOps** | 5,232 | Observability and evaluation for AI agents | [Repo](https://github.com/AgentOps-AI/agentops) |
| **LangSmith** | 754 | Debugging and monitoring for LLM applications | [Repo](https://github.com/langchain-ai/langsmith-sdk) |
| **Helicone** | 5,058 | Observability platform for Language Learning Models | [Repo](https://github.com/Helicone/helicone) |
| **LangFuse** | 21,280 | Open-source LLM engineering platform | [Repo](https://github.com/langfuse/langfuse) |
...
| **Composio** | - | Quick integration of 26,461+ tools for developers and agents | [Repo](https://github.com/ComposioHQ/composio) |
...
| Tool | Stars | Description | Links |
|:---|:---|:---|:---|
| **Instructor** | 12,270 | Python library for structured outputs from LLMs | [Repo](https://github.com/jxnl/instructor) |
| **Outlines** | 13,333 | Robust text generation library for agentic AI developers | [Repo](https://github.com/outlines-dev/outlines) |
| **Pydantic** | 26,612 | Python library for data validation through type hints | [Repo](https://github.com/pydantic/pydantic) |
...
| Tool | Stars | Description | Links |
|:---|:---|:---|:---|
| **Guardrails** | 6,329 | Python framework for building reliable AI applications | [Repo](https://github.com/guardrails-ai/guardrails) |
| **Guidance** | 21,231 | Programming paradigm for enhanced control in model generation | [Repo](https://github.com/guidance-ai/guidance) |
| **NeMo Guardrails** | 5,577 | Open-source toolkit for programmable guardrails | [Repo](https://github.com/NVIDIA/NeMo-Guardrails) |

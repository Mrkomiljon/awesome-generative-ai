...
|:---|:---|:---|:---|:---|:---|
| 27,702 | **AutoGPT** | 178,639 | Significant-Gravitas | Accessible AI tools for building and using AI agents | [Repo](https://github.com/Significant-Gravitas/AutoGPT) |
| 161,599 | **Ollama** | 152,864 | Ollama | Tool for running large language models locally | [Repo](https://github.com/ollama/ollama) |
| 125,855 | **LangChain** | 116,010 | LangChain AI | Framework enabling context-aware reasoning applications | [Repo](https://github.com/langchain-ai/langchain) |
| 71,900 | **Lobe Chat** | 65,772 | LobeHub | Open-source UI framework for ChatGPT/LLM-based chat apps | [Repo](https://github.com/lobehub/lobe-chat) |
| 67,458 | **OpenDevin** | 63,694 | OpenDevin | Open-source autonomous AI software engineer | [Repo](https://github.com/OpenDevin/OpenDevin) |
| 61,988 | **Open Interpreter** | 60,543 | OpenInterpreter | Coding agent enabling language models to execute code locally | [Repo](https://github.com/OpenInterpreter/open-interpreter) |
| 63,846 | **MetaGPT** | 58,552 | Geekan | Multi-agent framework enabling GPT collaboration | [Repo](https://github.com/geekan/MetaGPT) |
| 57,098 | **PrivateGPT** | 56,605 | Zylon AI | Secure, offline-capable AI tool for querying documents | [Repo](https://github.com/zylon-ai/private-gpt) |
| 55,211 | **GPT Engineer** | 54,883 | GPT Engineer Org | AI-powered tool for natural language software specification | [Repo](https://github.com/gpt-engineer-org/gpt-engineer) |
| 54,237 | **AutoGen** | 50,058 | Microsoft | Multi-agent conversation framework for LLM applications | [Repo](https://github.com/microsoft/autogen) |
...
|:---|:---|:---|:---|:---|
| **Flowise** | 48,790 | FlowiseAI | Drag-and-drop interface for AI workflows | [Repo](https://github.com/FlowiseAI/Flowise) |
| **FastChat** | 39,393 | LM-SYS | Platform for training, serving, and evaluating LLM chatbots | [Repo](https://github.com/lm-sys/FastChat) |
| **Cal.ai** | 40,023 | Cal.com | Open-source AI scheduling assistant | [Repo](https://github.com/calcom/cal.com/tree/main/apps/ai) |
| **Aider** | 40,322 | Paul Gauthier | Command-line tool for AI-assisted pair programming | [Repo](https://github.com/paul-gauthier/aider) |
| **Jan** | 40,305 | JanHQ | Open-source ChatGPT alternative that operates offline | [Repo](https://github.com/janhq/jan) |
| **CrewAI** | 43,579 | João Moura | Framework for orchestrating role-playing AI agents | [Repo](https://github.com/joaomdmoura/crewai) |
| **AgentGPT** | 35,652 | Reworkd | Configure and deploy autonomous AI agents | [Repo](https://github.com/reworkd/AgentGPT) |
| **GPT Pilot** | 33,760 | Pythagora | Open-source AI developer tool | [Repo](https://github.com/Pythagora-io/gpt-pilot) |
| **Tabby** | 32,833 | TabbyML | Self-hosted, open-source AI coding assistant | [Repo](https://github.com/TabbyML/tabby) |
...
|:---|:---|:---|:---|
| **SWE-agent** | 18,390 | Software engineering agent for GitHub repositories | [Repo](https://github.com/princeton-nlp/SWE-agent) |
| **Sweep** | 7,634 | AI tool that transforms GitHub issues into pull requests | [Repo](https://github.com/sweepai/sweep) |
| **Continue** | 31,231 | Open-source autopilot plugin for VS Code and JetBrains | [Repo](https://github.com/continuedev/continue) |
...
| Agent | Stars | Description | Links |
|:---|:---|:---|:---|
| **GPT Researcher** | 25,194 | AI-powered autonomous agent for online research | [Repo](https://github.com/assafelovic/gpt-researcher) |
...
| Agent | Stars | Description | Links |
|:---|:---|:---|:---|
| **ShortGPT** | 7,069 | AI-powered framework for automating content creation | [Repo](https://github.com/RayVentura/ShortGPT) |
...
| Agent | Stars | Description | Links |
|:---|:---|:---|:---|
| **OpenClaw** | 158,815k | Personal AI assistant for any OS and platform | [Repo](https://github.com/openclaw/openclaw) |
...
|:---|:---|:---|:---|
| **LangGraph** | 24,214 | Python library for stateful, multi-actor applications with LLMs | [Repo](https://github.com/langchain-ai/langgraph) |
| **SuperAGI** | 17,154 | Open-source framework for autonomous AI agents | [Repo](https://github.com/TransformerOptimus/SuperAGI) |
| **XAgent** | 8,492 | Open-source autonomous agent for complex task solving | [Repo](https://github.com/OpenBMB/XAgent) |
| **BabyAGI** | 22,119 | AI-powered task management system with OpenAI | [Repo](https://github.com/yoheinakajima/babyagi) |
| **ChatDev** | 29,808 | Virtual software company with intelligent agents | [Repo](https://github.com/OpenBMB/ChatDev) |
| **CAMEL** | 15,933 | Communicative agents for mind exploration | [Repo](https://github.com/camel-ai/camel) |
| **Qwen-Agent** | - | Agent framework from QwenLM for building tool-using LLM agents | [Repo](https://github.com/QwenLM/Qwen-Agent) |
| **AgentVerse** | 4,930 | Multi-LLM agent framework for various applications | [Repo](https://github.com/OpenBMB/AgentVerse) |
| **AgentCPM** | - | OpenBMB multi-agent framework built around CPM models and tooling | [Repo](https://github.com/OpenBMB/AgentCPM) |
| **Swarms** | 5,690 | Multi-agent collaboration for production applications | [Repo](https://github.com/kyegomez/swarms) |
| **Agno** | - | Agent framework for building multi-agent systems and tools | [Repo](https://github.com/agno-agi/agno) |
| **PraisonAI** | 5,590 | Low-code framework leveraging AutoGen and CrewAI | [Repo](https://github.com/MervinPraison/PraisonAI) |
...
|:---|:---|:---|:---|
| **MemGPT** | 20,968 | Customizable AI chatbot with self-editing memory | [Repo](https://github.com/cpacker/MemGPT) |
| **Letta** | - | Agent framework with long-term memory (MemGPT successor) | [Repo](https://github.com/letta-ai/letta) |
| **Zep** | 4,035 | Long-term memory service for AI assistants | [Repo](https://github.com/getzep/zep) |
...
| **mem46,538** | - | Open-source memory layer for LLM apps | [Repo](https://github.com/mem0ai/mem0) |
...
| **ScrapeGraphAI** | 22,478 | AI agents for automated web scraping | [Repo](https://github.com/VinciGit00/Scrapegraph-ai) |
| **Self Operating Computer** | 10,131 | Multimodal models for computer interaction | [Repo](https://github.com/OthersideAI/self-operating-computer) |
| **AppAgent** | 6,503 | Mobile-friendly LLM-based multimodal agent | [Repo](https://github.com/mnotgod96/AppAgent) |
...
| **crawl59,413ai** | - | AI-first web crawler and scraper | [Repo](https://github.com/unclecode/crawl4ai) |
...
|:---|:---|:---|:---|
| **AgentBench** | 3,143 | Benchmark for evaluating LLM agents | [Repo](https://github.com/THUDM/AgentBench) |
| **AgentOps** | 5,247 | Observability and evaluation for AI agents | [Repo](https://github.com/AgentOps-AI/agentops) |
...
| **Composio** | - | Quick integration of 26,484+ tools for developers and agents | [Repo](https://github.com/ComposioHQ/composio) |
...
| Tool | Stars | Description | Links |
|:---|:---|:---|:---|
| **Instructor** | 12,303 | Python library for structured outputs from LLMs | [Repo](https://github.com/jxnl/instructor) |
| **Outlines** | 13,367 | Robust text generation library for agentic AI developers | [Repo](https://github.com/outlines-dev/outlines) |
| **Pydantic** | 26,666 | Python library for data validation through type hints | [Repo](https://github.com/pydantic/pydantic) |
...
| Tool | Stars | Description | Links |
|:---|:---|:---|:---|
| **Guardrails** | 6,357 | Python framework for building reliable AI applications | [Repo](https://github.com/guardrails-ai/guardrails) |
| **Guidance** | 21,251 | Programming paradigm for enhanced control in model generation | [Repo](https://github.com/guidance-ai/guidance) |
| **NeMo Guardrails** | 5,603 | Open-source toolkit for programmable guardrails | [Repo](https://github.com/NVIDIA/NeMo-Guardrails) |
